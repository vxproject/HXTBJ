...
module.exports = {
  ...
  // 订单管理
  pay_order_status, order_return_pay, cart_order, add_comment, goods_confirm, order_detail, order_type_number, wx_pay, add_order, order_cancel, order_goods_list, order_return_submit, order_list,
  //会员管理
